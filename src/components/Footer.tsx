...
const Footer = () => {
  return (
    <>
      <SocialMediaFooter />
      <footer className="max-w-screen-2xl mx-auto border-b-8 border-brand-gold px-5 max-[400px]:px-3 bg-brand-charcoal text-brand-cream">
        ...
        <div className="flex flex-col gap-8 my-20">
          ...
          <h2 className="text-6xl font-serif text-center max-sm:text-5xl">ELENZA</h2>
